...
@Component({
  selector: 'app-list-alumno-docente',
  standalone: false,
  templateUrl: './list-alumno-docente.component.html',
  styleUrl: './list-alumno-docente.component.css'
})
export class ListAlumnoDocenteComponent implements OnInit {
  // === Estado general ===
